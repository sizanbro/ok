...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "oi") || (event.body.toLowerCase() == "Oi") || (event.body.toLowerCase() == "ওই") || (event.body.toLowerCase() == "janu")) || (event.body.toLowerCase() == "Janu")) {
     return api.sendMessage("হ্যাঁ jaan বলো..! 😊❤️", threadID);
   };
